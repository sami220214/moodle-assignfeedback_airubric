...
$string['noteligible_nosubmissiontext'] = 'Student submission does not contain online text or readable Word document text.';
...
$string['enabled_help'] = 'If enabled, AI feedback assistant can be used in assignment feedback. Online text or Word document submissions and rubric grading method are required for AI feedback to be available.';
