...
$string['enabled_help'] = 'If enabled, AI feedback assistant can be used in assignment feedback. Online text submissions and rubric grading method are required for AI feedback to be available.';
