...
$string['noteligible_nosubmissiontext'] = 'Palautuksessa ei ole online-tekstiä tai luettavaa Word-dokumentin tekstiä.';
...
$string['enabled_help'] = 'Jos tämä on käytössä, tekoälypalauteavustajaa voidaan käyttää tehtävän palautteenannossa. Online-teksti- tai Word-dokumenttipalautus ja arviointimatriisi vaaditaan, jotta tekoälyapuria voidaan käyttää.';
