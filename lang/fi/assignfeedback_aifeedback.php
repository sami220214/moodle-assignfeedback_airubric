...
$string['enabled_help'] = 'Jos tämä on käytössä, tekoälypalauteavustajaa voidaan käyttää tehtävän palautteenannossa. Online-tekstipalautukset ja arviointimatriisi vaaditaan, jotta tekoälyapuria voidaan käyttää.';
